  ...
  function(t, e, n) {
    ...
    Pt.prototype = {
          ...
          if (
            ...
            (e = (function(t) {
              ...
              for (n = [], i = 0; i < e; i++) {
                ...
                if (
                  ((o = 10),
                  r.length > 1 && "0" == P(r, 0) && ((o = D(G, r) ? 16 : 8), (r = U(r, 8 == o ? 1 : 2))),
                  "" === r)
                )
                  s = 0;
                else {
      ...
      setSearch: function(t) {
        "" == (t = b(t))
          ? (this.query = null)
          : ("?" == P(t, 0) && (t = U(t, 1)), (this.query = ""), this.parse(t, It)),
          this.searchParams.update();
      },
      ...
      setHash: function(t) {
        "" != (t = b(t))
          ? ("#" == P(t, 0) && (t = U(t, 1)), (this.fragment = ""), this.parse(t, Mt))
          : (this.fragment = null);
      },
      update: function() {
        ...
        return (
          !t &&
            ...
            (t = {
              ...
              "info-verbosity": "info",
              infoVerbosity: "info",
              $0: "/Volumes/Data/Projects/IDFive/iastate22-frontend/node_modules/.bin/webpack",
            }.DEBUG),
          t
        );
      }
...
*/
  ...
  function(t, e, n) {
    ...
    function $(t) {
      ...
      return n && ("html" === C(n) || ("body" === C(n) && "static" === q(n).position))
        ? e
        : n ||
            (function(t) {
        ...
        if (k) {
          if (u) {
            var j,
              ...
              nt = tt[z],
              it = G(0, C[q], J[q]),
              rt = S ? C[q] / 2 - V - it - et - I.mainAxis : X - it - et - I.mainAxis,
              ot = S ? -C[q] / 2 + V + it + nt + I.mainAxis : Q + it + nt + I.mainAxis,
    ...
    class gi extends ye {
      ...
      _selectMenuItem({ key: t, target: e }) {
        const n = Me.find(si, this._menu).filter(qt);
